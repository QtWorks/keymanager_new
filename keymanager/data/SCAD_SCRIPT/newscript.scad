...
extra_material_level1_use =                  qt_extra_material_level1_use_qt;
...
dimple_cut_use =                             qt_dimple_cut_use_qt;
...
extra_cut_level2_use =                               qt_extra_cut_level2_use_qt;
...
extra_material_level3_use =                  qt_extra_material_level3_use_qt;
...
extra_cut_level4_use =                               qt_extra_cut_level4_use_qt;
...
{
    if(extra_material_level1_use == "YES")   
    {    
...
{
    if(extra_material_level3_use == "YES")   
    {    
